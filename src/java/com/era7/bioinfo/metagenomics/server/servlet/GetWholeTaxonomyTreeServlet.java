 ...
 */
public class GetWholeTaxonomyTreeServlet extends BasicServletNeo4j {
    ...
    protected Response processRequest(Request rqst, BasicSession bs, Bio4jManager mn, HttpServletRequest hsr) throws Throwable {
        ...
        if (rqst.getMethod().equals(RequestList.GET_WHOLE_TAXONOMY_TREE_REQUEST)) {

            NodeRetriever nodeRetriever = new NodeRetriever(mn);
            
            NCBITaxonNode rootTaxon = nodeRetriever.getNCBITaxonByTaxId("1");
            ...
            getTaxonomySubTree(rootTaxon, rootNodeXML, graph);
    ...
    private String getTaxonomySubTree(NCBITaxonNode currentNode, 
        ...
        for (NCBITaxonNode childNode : children) {
            ...
            String tempTaxId = getTaxonomySubTree(childNode, childXML, graph);  
